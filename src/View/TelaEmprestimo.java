...
public class TelaEmprestimo extends javax.swing.JFrame {
    ...
    public TelaEmprestimo() {
        ...
        List<EmprestimoBEAN> listAllEmprestimos = controleEmprestimo.listaEmprestimosAtivos();      
        limpar_tabela();
        preencher_tabela(listAllEmprestimos);
    }
    ...
    private void initComponents() {
        ...
        jTableEmprestimos.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jTableEmprestimos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "AMIGO", "DESCRIÇÃO", "DATA INÍCIO", "DATA FINAL", "STATUS"
            }
        ));
        jTableEmprestimos.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
    ...
    private void jButtonAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAtualizarActionPerformed
        List<EmprestimoBEAN> listEmprestimosAtivos = controleEmprestimo.listaEmprestimosAtivos();
        limpar_tabela();
        preencher_tabela(listEmprestimosAtivos);
    ...
    private void jButtonAtivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAtivarActionPerformed
        int index = jTableEmprestimos.getSelectedRow();
        String idString = jTableEmprestimos.getValueAt(index, 0).toString();
        int id = Integer.parseInt(idString);

        EmprestimoBEAN emprestimo = new EmprestimoBEAN(id);
        controleEmprestimo.ativarEmprestimo(emprestimo);
    ...
    private void jButtonInativarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInativarActionPerformed
        ...
        EmprestimoBEAN emprestimo = new EmprestimoBEAN(id);
        controleEmprestimo.inativarEmprestimo(emprestimo);
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        List<EmprestimoBEAN> consulta = controleEmprestimo.consultaEmprestimo(jTextPesquisar.getText(), ativo, inativo);
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        String nomeAmigo = jTableEmprestimos.getValueAt(index, 1).toString();
        String descricao = jTableEmprestimos.getValueAt(index, 2).toString();
        Date data = (Date) jTableEmprestimos.getValueAt(index, 3);
        Date datafinal = (Date) jTableEmprestimos.getValueAt(index, 4);
        String statusEmprestimo = jTableEmprestimos.getValueAt(index, 5).toString();
        
        new TelaEditarEmprestimo(id, nomeAmigo, descricao, data, datafinal, statusEmprestimo).setVisible(true);
        this.dispose();
    ...
    private void jTableEmprestimosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableEmprestimosMouseClicked
        preencher_tabelaAuxiliar();
        
        int index = jTableEmprestimos.getSelectedRow();
        String status = jTableEmprestimos.getValueAt(index, 5).toString();
    ...
    public void limpar_tabela() {
        for (int i = 0; i < this.jTableEmprestimos.getRowCount(); i++) {
            this.jTableEmprestimos.setValueAt("", i, 0);
            this.jTableEmprestimos.setValueAt("", i, 1);
            this.jTableEmprestimos.setValueAt("", i, 2);
            this.jTableEmprestimos.setValueAt("", i, 3);
            this.jTableEmprestimos.setValueAt("", i, 4);
            this.jTableEmprestimos.setValueAt("", i, 5);
        }
    }
    
    public void preencher_tabela(List<EmprestimoBEAN> listaEmprestimos) {
        javax.swing.table.DefaultTableModel modelo = (javax.swing.table.DefaultTableModel) jTableEmprestimos.getModel();
        
        jTableEmprestimos.getColumnModel().getColumn(0).setPreferredWidth(20);
        jTableEmprestimos.getColumnModel().getColumn(1).setPreferredWidth(80);
        jTableEmprestimos.getColumnModel().getColumn(2).setPreferredWidth(150);
        jTableEmprestimos.getColumnModel().getColumn(3).setPreferredWidth(50);
        jTableEmprestimos.getColumnModel().getColumn(4).setPreferredWidth(50);
        jTableEmprestimos.getColumnModel().getColumn(5).setPreferredWidth(50);
        
        modelo.setNumRows(0);
        try {
            for (EmprestimoBEAN emprestimo : listaEmprestimos) {
                String nomeAmigo = controleAmigo.consultaAmigoById(emprestimo.getIDAmigos());
                        
                modelo.addRow(new Object[]{emprestimo.getIDEmprestimo(), nomeAmigo, emprestimo.getDescricao(), emprestimo.getData(), emprestimo.getDataFim(), emprestimo.getStatusEmprestimo()});
            }
    ...
    public void preencher_tabelaAuxiliar() {
        int index = jTableEmprestimos.getSelectedRow();
        String idString = jTableEmprestimos.getValueAt(index, 0).toString();
        int id = Integer.parseInt(idString);

        List<LivroBEAN> listaLivros = controleEmprestimo.listaLivrosDoEmprestimo(id);
        DefaultTableModel modelo = (DefaultTableModel) jTableLivros.getModel();
        jTableLivros.getColumnModel().getColumn(0).setPreferredWidth(80);
        modelo.setNumRows(0);

        try {
            for (LivroBEAN livro : listaLivros) {
                modelo.addRow(new Object[]{livro.getTitulo()});
            }
        } catch (Exception erro) {
            JOptionPane.showMessageDialog(null, "Erro ao listar dados - " + erro);
        }
